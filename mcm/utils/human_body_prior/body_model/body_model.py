...
from utils.human_body_prior.body_model.lbs import lbs
import sys
...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.model_type = \
            {69: 'smpl', 153: 'smplh', 162: 'smplx', 45: 'mano', 105: 'animal_horse', 102: 'animal_dog', }[njoints]
    ...
    def r(self):
        from utils.human_body_prior.tools.omni_tools import copy2cpu as c2c
    ...
    def forward(self, root_orient=None, pose_body=None, pose_hand=None, pose_jaw=None, pose_eye=None, betas=None,
        ...
        if pose_hand is None and self.model_type not in ['animal_horse',
                                                         'animal_dog']:  pose_hand = self.init_pose_hand.expand(
            batch_size, -1)
