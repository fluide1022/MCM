...
def inverse_kinematics_quats(joints_global_rotations: torch.Tensor, joints_global_positions: torch.Tensor,
    ...
    for level in range(len(level_joints) - 1, 0, -1):
        ...
        joint_local_quats[..., level_bone_indices, :] = quaternion_multiply(
            quaternion_invert(parent_level_global_quats), level_global_quats)
        joint_local_positions[..., level_bone_indices, :] = quaternion_apply(
            quaternion_invert(parent_level_global_quats), level_global_positions - parent_level_global_positions)
