...
from utils.quaternion import qrot_np, qmul_np, quaternion_to_cont6d_np, qinv_np, qfix, qbetween_np
...
example_data = np.load('data/humanml3d/reference.npy')
...
if __name__ == '__main__':
    joint_ori_dir = 'data/aist_plusplus_final/joints_22_raw'
    os.makedirs('data/aist_plusplus_final/joints_22', exist_ok=True)
    os.makedirs('data/aist_plusplus_final/joints_22_vecs', exist_ok=True)
